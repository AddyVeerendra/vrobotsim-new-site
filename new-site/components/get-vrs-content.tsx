      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-16">
        <div className="container text-center">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Choose your Virtual Robot Simulator version and start programming
            FTC robots without the hardware. Launch online or download for
            offline use.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              New to VRS? Check out our quickstart guide to learn the basics of
              programming robots in the virtual environment.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Previous VRS versions that are still available for teams who
                need them. We recommend using the current versions above for the
                best experience.
              </p>
            </div>
